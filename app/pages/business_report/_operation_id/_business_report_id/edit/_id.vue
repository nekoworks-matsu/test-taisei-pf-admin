          ...
          <div class="box-body no-paddin">
            <form class="form-horizontal">
              ...
              <div class="box-footer form_button_flex flex_right border_top">
                ...
                <button type="button" class="btn btn-default global_btn form_button_flex_item" @click="onCancelButtonClick('/business_report/' + $route.params.operation_id + '/' + $route.params.business_report_id  + '/details/' + param.id)">キャンセル</button>
...
export default {
  ...
  methods: {
    ...
    getMajoritemsData(api) {
      this.onSearch(api, null, null, (val) => {
        // this.param.title = val.businessReportDefinition.name //大項目名
        const columns_list = []
        var cnt = 0
        var daily_data = '';
