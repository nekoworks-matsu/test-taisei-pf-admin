      ...
      <div class="ts_content_head">
        <div class="button_header">
          ...
          <div class="button_header_btn">
            <button type="button" class="btn btn-info global_btn" v-if="checkMenuPermission('Master:OperationType:update')" @click="onTransitionButton('/company_operation_types/edit/' + item.id)">編集</button>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="box-body no-paddin">
            <form class="form-horizontal" autocomplete="off">
              ...
              <div class="box-footer form_button_flex flex_center border_top">
                <button type="button" class="btn btn-default global_btn form_button_flex_item" @click="onTransitionButton('/company_operation_types')">戻る</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
...
<script>
  ...
  export default {
    ...
    created() {
      const key = "Master:OperationType:view";
