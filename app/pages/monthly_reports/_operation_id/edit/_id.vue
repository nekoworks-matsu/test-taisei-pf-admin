    ...
    <!-- <section class="content-header">
      <h1>
        ...
        <div class="pull-right">
          <button type="button" class="btn btn-default width_140" @click="onTransitionButton('/monthly_reports/' + $route.params.operation_id + '/details/' + $route.params.id)">キャンセル</button>
        </div>
      </h1>
    </section> -->
          ...
          <section>
            <div class="ts_breadcrumb">
              <ol>
                ...
                <li>月次報告書一覧</li>
                <li>月次報告書詳細</li>
                <li class="current">月次報告書編集</li>
              </ol>
            </div>
            <h1 class="ts_content_heading">月次報告書編集</h1>
          </section>
        ...
        <div class="box-body no-paddin">
            ...
            <div class="box-body">
              <div class="form-group form_box_group">
                ...
                <div class="form_box_group_field">
                  <div class="item-text">
                    {{dfMonth(param.reportYearMonth)}}
                  </div>
                </div>
              </div>
              <div class="form-group">
                <!-- <div class="no-margin pull-right">
                  <button type="button" v-if="!isOwner" class="btn btn-primary margin_right_20" @click="readReportData">月次データ読み込み</button>
                </div> -->
              </div>
              ...
              <div class="form-group form_box_group">
                ...
                <div class="flex_textarea form_box_group_field">
              ...
              <!-- <div class="no-margin pull-left">
                <button type="button" v-bind:disabled="readingFlag" class="btn btn-primary" @click="outPdf">PDFダウンロード</button>
              </div> -->
            </div>
          ...
          <div name="report_body" v-if="readReportFlag">
                ...
                <div v-if="chartData.appear">
                  ...
                  <div class="form-group padding_bottom_30 margin_top_20 margin_right_m15">
                    ...
                    <div class="col-sm-10 flex_textarea">
                      <div class="flex_textarea_dummy_one" aria-hidden="true">{{chartData.note}}</div>
                ...
                <div class="box-body margin_left_0">
                  ...
                  <div class="form-group margin_right_m15 margin_top_5">
                    ...
                    <div class="col-sm-10 flex_textarea margin_top_5">
                      <div class="flex_textarea_dummy_one" aria-hidden="true">{{other.body}}</div>
                    ...
                    <div class="report_file_select"> -->
                      ...
                      <div class="float_left padding_right_30" v-for="(image, imgIndex) in other.monthlyReportOtherImages">
                        ...
                        <div class="margin_top_5">
                          <button type="button" v-if="!isOwner" class="btn btn-primary" @click="onSelectFileClick(index+'_'+imgIndex)">ファイル選択</button>&nbsp;※ファイル容量5MB以下 
                        </div>
                        <div class="margin_top_5 img_div_monthly_report padding_bottom_25">
                          ...
                          <button type="button" v-if="image!=null&&!isOwner" class="btn btn-danger pull-right-top" @click="onDeleteFileClick(index+'_'+imgIndex)"><i class="fa fa-times"></i></button>
                        </div>
                      </div>
            ...
            <div class="box-footer form_button_flex flex_right border_top">
              <button type="button" class="btn btn-danger global_btn form_button_flex_item margin_right_auto" v-if="this.checkMenuPermission('Security:MonthlyReport:delete') || this.checkMenuPermission('Cleaning:MonthlyReport:delete')" @click="onDeleteFunc()">削除</button>
              <button type="button" class="btn btn-default global_btn form_button_flex_item" @click="onTransitionButton('/monthly_reports/' + $route.params.operation_id + '/details/' + $route.params.id)">キャンセル</button>
              <button type="button" v-if="this.checkMenuPermission('Security:MonthlyReport:update') || this.checkMenuPermission('Cleaning:MonthlyReport:update')" v-bind:disabled="uploading" class="btn btn-warning global_btn form_button_flex_item"  @click="onAddButtonClick">保存</button>
            </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
        ...
        this.chartDatas.forEach((chartData) => {
          reportList.forEach((job) => {
            ...
            if (this.isHeadquartersMode) {
              var memberOperation = JSON.parse(localStorage.getItem('member_operation'));
              const operationCategories = JSON.parse(localStorage.getItem('operation_categories'));
              const currentCategory = operationCategories.find(val => val.id == parseInt(this.$route.params.operation_id));
              const operationCategory = memberOperation.find(val => val.operationCategoryId == currentCategory.operationTypeId);
              groups = this.getReportObjectGroupDefinitions(operationCategory.operationCategory.operationCategoryContents)
            }
      ...
      onAddButtonClick() {
        ...
        var count_cond = {
          and:[
            ...
            {buildingId:  (this.isHeadquartersMode ? this.buildingId : parseInt(localStorage.getItem('buildings_id')))}
          ]
        };
      ...
      deleteFunc() {
        this.onDelete(this.param.api, '/monthly_reports/' + this.operationId )
    ...
    created() {
      const key = (parseInt(this.$route.params.operation_id) == 1) ? "Security:MonthlyReport:update" : "Cleaning:MonthlyReport:update";
