      ...
      <div class="ts_content_head">
        <div class="button_header">
          ...
          <div class="button_header_btn">
            <button type="button" class="btn btn-info global_btn" @click="onTransitionButton('/majoritems/' + $route.params.operation_id + '/' + $route.params.majoritems_id  + '/edit/' + param.id)">編集</button>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="box-body no-paddin">
            <form class="form-horizontal">
              ...
              <div class="box-footer form_button_flex flex_center border_top">
                <button type="button" class="btn btn-default global_btn form_button_flex_item" @click="onTransitionButton('/majoritems/' + $route.params.operation_id + '/' + $route.params.majoritems_id)">戻る</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
...
export default {
  ...
  methods: {
    ...
    onOKButton() {
      this.$router.push('/majoritems/' + this.$route.params.operation_id + '/' + this.$route.params.majoritems_id + '/add/' )
    },
    copyContents() {
